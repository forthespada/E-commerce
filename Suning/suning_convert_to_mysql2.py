...
def main():
	...
	df = pd.read_csv(r'F:\suning_comments.csv')
	...
	for i in range(num):
		...
		cursor = db.cursor()
		product_sql = "INSERT INTO suning_product2(product_id,product_name,product_url,product_price,product_description,product_categories,time) VALUES(%s,%s,%s,%s,%s,%s,%s)"
		...
		if item['comments'] is not np.nan:
			...
			review_sql = "INSERT INTO suning_review2(product_id,review_id,reviewer_nickname,review_content,review_rating,review_helpful,review_time,time) VALUES(%s,%s,%s,%s,%s,%s,%s,%s)"
